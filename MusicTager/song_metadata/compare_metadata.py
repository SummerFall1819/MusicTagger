...
def get_duration_seconds(duration_text: str) -> int:
    """把文本格式的时间转化为整型"""
...
def compare_song_info(song_info_1: SongInfo, song_info_2: SongInfo) -> int:
    ...
    if not song_info_1 or not song_info_2:
        return 0
    duration_1 = get_duration_seconds(song_info_1.duration)
    duration_2 = get_duration_seconds(song_info_2.duration)
    score_list = []
